...
`,er=class{constructor(e,t){this.backendUrl=e,this.apiKey=t,this.maxRetries=3,this.retryDelay=1e3}async createChatSession(e){const t={};void 0!==e&&(t.persona_id=e);const n=await this.fetchWithRetry(`${this.backendUrl}/chat/create-chat-session`,{method:"POST",headers:this.getHeaders(),body:JSON.stringify(t)});if(!n.ok){let e=n.statusText;try{const t=await n.json();t.detail&&(e=t.detail)}catch{}throw new Error(e)}return(await n.json()).chat_session_id}async*streamMessage(e){const t={message:e.message,chat_session_id:e.chatSessionId,parent_message_id:e.parentMessageId??null,origin:"widget",include_citations:e.includeCitations??!1},n=await this.fetchWithRetry(`${this.backendUrl}/chat/send-chat-message`,{method:"POST",headers:this.getHeaders(),body:JSON.stringify(t),signal:e.signal});if(!n.ok){let e=n.statusText;try{const t=await n.json();t.detail&&(e=t.detail)}catch{}throw new Error(e)}yield*this.parseSSEStream(n)}async*parseSSEStream(e){const t=e.body?.getReader();if(!t)throw new Error("Response body is not readable");const n=new TextDecoder;let r="";try{for(;;){const{done:e,value:i}=await t.read();if(e)break;r+=n.decode(i,{stream:!0});const s=r.split("\n");r=s.pop()||"";for(const t of s)if(t.trim())try{const e=JSON.parse(t);"user_message_id"in e&&"reserved_assistant_message_id"in e?yield{obj:e}:yield e}catch(fe){throw new Error(`Failed to parse SSE packet: ${t}. Error: ${fe}`)}}if(r.trim())try{const e=JSON.parse(r);"user_message_id"in e&&"reserved_assistant_message_id"in e?yield{obj:e}:yield e}catch(fe){throw new Error(`Failed to parse final packet: ${r}. Error: ${fe}`)}}finally{t.releaseLock()}}async fetchWithRetry(e,t,n=0){try{const r=await fetch(e,t);if(!r.ok&&n<this.maxRetries&&r.status>=500){const r=this.retryDelay*Math.pow(2,n);return await new Promise(e=>setTimeout(e,r)),this.fetchWithRetry(e,t,n+1)}return r}catch(r){if(r instanceof Error&&"AbortError"===r.name)throw r;if(n<this.maxRetries){const r=this.retryDelay*Math.pow(2,n);return await new Promise(e=>setTimeout(e,r)),this.fetchWithRetry(e,t,n+1)}throw r}}getHeaders(){return{"Content-Type":"application/json",Authorization:`Bearer ${this.apiKey}`}}};function tr(e,t){if(!e||!e.obj)throw new Error("Received malformed packet: packet.obj is missing");const n=e.obj;if("reserved_assistant_message_id"in n&&"user_message_id"in n)return{message:t,messageIds:{userMessageId:n.user_message_id,assistantMessageId:n.reserved_assistant_message_id}};if(!("type"in n))throw new Error("Packet missing type field");switch(n.type){case"message_start":return{message:{id:`msg-${Date.now()}`,role:"assistant",content:"",timestamp:Date.now(),isStreaming:!0},status:""};case"message_delta":return t&&"assistant"===t.role?{message:{...t,content:t.content+(n.content||"")}}:{message:t};case"citation_info":return{message:t,citation:{citation_number:n.citation_number,document_id:n.document_id}};case"search_tool_start":return{message:t,status:n.is_internet_search?"Searching the web...":"Searching internally..."};case"search_tool_queries_delta":return{message:t,status:"Generating search queries..."};case"search_tool_documents_delta":return{message:t,documents:n.documents,status:"Reading documents..."};case"open_url_start":return{message:t,status:"Opening URLs..."};case"open_url_urls":return{message:t,status:"Fetching web pages..."};case"open_url_documents":return{message:t,documents:n.documents,status:"Processing web content..."};case"image_generation_start":case"image_generation_heartbeat":return{message:t,status:"Generating image..."};case"python_tool_start":case"python_tool_delta":return{message:t,status:"Running Python code..."};case"custom_tool_start":return{message:t,status:"Running custom tool..."};case"reasoning_start":case"reasoning_delta":return{message:t,status:"Thinking..."};case"deep_research_plan_start":return{message:t,status:"Planning research..."};case"research_agent_start":return{message:t,status:"Researching..."};case"intermediate_report_start":return{message:t,status:"Generating report..."};case"stop":case"overall_stop":return t?{message:{...t,isStreaming:!1}}:{message:t};case"error":throw new Error(`Stream error: ${n.exception}`);default:return{message:t}}}var nr="onyx-widget-session";function rr(e,t){try{const n={sessionId:e,messages:t,timestamp:Date.now()};sessionStorage.setItem(nr,JSON.stringify(n))}catch(fe){}}function ir(){try{sessionStorage.removeItem(nr)}catch(fe){}}var sr;function ar(e,t,n,r){var i,s=arguments.length,a=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var o=e.length-1;o>=0;o--)(i=e[o])&&(a=(s<3?i(a):s>3?i(t,n,a):i(t,n))||a);return s>3&&a&&Object.defineProperty(t,n,a),a}var or=class extends le{static{sr=this}static{this.styles=[Xn,$n]}constructor(){super(),this.isOpen=!1,this.messages=[],this.isLoading=!1,this.isStreaming=!1,this.streamingStatus="",this.inputValue="",this.showEmptyPlaceholder=!1,this.showEmptyHiding=!1,this.documentMap=/* @__PURE__ */new Map,this.citationMap=/* @__PURE__ */new Map,Lt.setOptions({breaks:!0,gfm:!0})}updated(e){super.updated(e),(e.has("messages")||e.has("isStreaming"))&&this.scrollToBottom()}scrollToBottom(){requestAnimationFrame(()=>{const e=this.shadowRoot?.querySelector(".messages");e&&(e.scrollTop=e.scrollHeight)})}connectedCallback(){super.connectedCallback(),this.config=function(e){const t={backendUrl:e.backendUrl||"",apiKey:e.apiKey||"",agentId:e.agentId,primaryColor:e.primaryColor,backgroundColor:e.backgroundColor,textColor:e.textColor,agentName:e.agentName||"Assistant",logo:e.logo,mode:e.mode||"launcher",includeCitations:e.includeCitations??!1};if(!t.backendUrl||!t.apiKey)throw new Error("backendUrl and apiKey are required for the widget to function");return t}({backendUrl:this.backendUrl,apiKey:this.apiKey,agentId:this.agentId,primaryColor:this.primaryColor,backgroundColor:this.backgroundColor,textColor:this.textColor,agentName:this.agentName,logo:this.logo,mode:this.mode,includeCitations:this.includeCitations}),this.applyCustomColors(),this.apiService=new er(this.config.backendUrl,this.config.apiKey);const e=function(){try{const e=sessionStorage.getItem(nr);if(!e)return null;const t=JSON.parse(e);return Date.now()-t.timestamp>864e5?(ir(),null):t}catch(fe){return null}}();e&&(this.chatSessionId=e.sessionId,this.messages=e.messages),this.showEmptyPlaceholder=0===this.messages.length,"inline"===this.config.mode&&(this.isOpen=!0)}applyCustomColors(){this.config.primaryColor&&(this.style.setProperty("--theme-primary-05",this.config.primaryColor),this.style.setProperty("--theme-primary-06",this.adjustBrightness(this.config.primaryColor,-10))),this.config.backgroundColor&&(this.style.setProperty("--background-neutral-00",this.config.backgroundColor),this.style.setProperty("--background-neutral-03",this.adjustBrightness(this.config.backgroundColor,-10))),this.config.textColor&&this.style.setProperty("--text-04",this.config.textColor)}adjustBrightness(e,t){const n=parseInt(e.replace("#",""),16),r=Math.round(2.55*t),i=(n>>16)+r,s=(n>>8&255)+r,a=(255&n)+r;return"#"+(16777216+65536*(i<255?i<1?0:i:255)+256*(s<255?s<1?0:s:255)+(a<255?a<1?0:a:255)).toString(16).slice(1)}resetConversation(){this.abortController&&(this.abortController.abort(),this.abortController=void 0),this.messages=[],this.chatSessionId=void 0,this.error=void 0,this.inputValue="",this.isStreaming=!1,this.isLoading=!1,this.streamingStatus="",this.documentMap.clear(),this.citationMap.clear(),ir(),this.showEmptyPlaceholder=!0}renderMarkdown(e,t){try{let n=e;if(this.config.includeCitations)if(t?.length){const e=/* @__PURE__ */new Map;t.forEach((t,n)=>e.set(t.citation_number,n+1)),n=n.replace(/\[\[(\d+)\]\]\([^)]*\)/g,(t,n)=>{const r=e.get(Number(n));return r?`<sup>[${r}]</sup>`:""})}else n=n.replace(/\[\[(\d+)\]\]\([^)]*\)/g,"");const r=Lt.parse(n,{async:!1});return xe(Qn.sanitize(r,{ADD_TAGS:["sup"]}))}catch(n){return e}}static{this.CITATIONS_COLLAPSED_COUNT=1}renderCitationBadge(e,t){const n=e.semantic_identifier||"Source",r=e.link&&/^https?:\/\//i.test(e.link)?e.link:void 0;return r?Z`<a
        ...
        >`}toggleCitationExpand(e){const t=e.target.closest(".citation-list");t&&t.classList.toggle("expanded")}renderCitations(e){if(!e?.length)return"";const t=sr.CITATIONS_COLLAPSED_COUNT,n=e.slice(0,t),r=e.slice(t);return Z`
    ...
    `}};ar([ue({attribute:"backend-url"})],or.prototype,"backendUrl",void 0),ar([ue({attribute:"api-key"})],or.prototype,"apiKey",void 0),ar([ue({attribute:"agent-id",type:Number})],or.prototype,"agentId",void 0),ar([ue({attribute:"primary-color"})],or.prototype,"primaryColor",void 0),ar([ue({attribute:"background-color"})],or.prototype,"backgroundColor",void 0),ar([ue({attribute:"text-color"})],or.prototype,"textColor",void 0),ar([ue({attribute:"agent-name"})],or.prototype,"agentName",void 0),ar([ue({attribute:"logo"})],or.prototype,"logo",void 0),ar([ue()],or.prototype,"mode",void 0),ar([ue({attribute:"include-citations",type:Boolean})],or.prototype,"includeCitations",void 0),ar([de()],or.prototype,"isOpen",void 0),ar([de()],or.prototype,"chatSessionId",void 0),ar([de()],or.prototype,"messages",void 0),ar([de()],or.prototype,"isLoading",void 0),ar([de()],or.prototype,"isStreaming",void 0),ar([de()],or.prototype,"streamingStatus",void 0),ar([de()],or.prototype,"error",void 0),ar([de()],or.prototype,"inputValue",void 0),ar([de()],or.prototype,"showEmptyPlaceholder",void 0),ar([de()],or.prototype,"showEmptyHiding",void 0),or=sr=ar([(e=>(t,n)=>{void 0!==n?n.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)})("onyx-chat-widget")],or),"undefined"==typeof customElements||customElements.get("onyx-chat-widget")||customElements.define("onyx-chat-widget",or);export{or as OnyxChatWidget};