...
`,nr=class{constructor(e,t){this.backendUrl=e,this.apiKey=t,this.maxRetries=3,this.retryDelay=1e3}async createChatSession(e){const t={};void 0!==e&&(t.persona_id=e);const n=await this.fetchWithRetry(`${this.backendUrl}/chat/create-chat-session`,{method:"POST",headers:this.getHeaders(),body:JSON.stringify(t)});if(!n.ok){let e=n.statusText;try{const t=await n.json();t.detail&&(e=t.detail)}catch{}throw new Error(e)}return(await n.json()).chat_session_id}async*streamMessage(e){const t={message:e.message,chat_session_id:e.chatSessionId,parent_message_id:e.parentMessageId??null,origin:"widget",include_citations:e.includeCitations??!1},n=await this.fetchWithRetry(`${this.backendUrl}/chat/send-chat-message`,{method:"POST",headers:this.getHeaders(),body:JSON.stringify(t),signal:e.signal});if(!n.ok){let e=n.statusText;try{const t=await n.json();t.detail&&(e=t.detail)}catch{}throw new Error(e)}yield*this.parseSSEStream(n)}async*parseSSEStream(e){const t=e.body?.getReader();if(!t)throw new Error("Response body is not readable");const n=new TextDecoder;let r="";try{for(;;){const{done:e,value:i}=await t.read();if(e)break;r+=n.decode(i,{stream:!0});const s=r.split("\n");r=s.pop()||"";for(const t of s)if(t.trim())try{const e=JSON.parse(t);"user_message_id"in e&&"reserved_assistant_message_id"in e?yield{obj:e}:yield e}catch(fe){throw new Error(`Failed to parse SSE packet: ${t}. Error: ${fe}`)}}if(r.trim())try{const e=JSON.parse(r);"user_message_id"in e&&"reserved_assistant_message_id"in e?yield{obj:e}:yield e}catch(fe){throw new Error(`Failed to parse final packet: ${r}. Error: ${fe}`)}}finally{t.releaseLock()}}async fetchWithRetry(e,t,n=0){try{const r=await fetch(e,t);if(!r.ok&&n<this.maxRetries&&r.status>=500){const r=this.retryDelay*Math.pow(2,n);return await new Promise(e=>setTimeout(e,r)),this.fetchWithRetry(e,t,n+1)}return r}catch(r){if(r instanceof Error&&"AbortError"===r.name)throw r;if(n<this.maxRetries){const r=this.retryDelay*Math.pow(2,n);return await new Promise(e=>setTimeout(e,r)),this.fetchWithRetry(e,t,n+1)}throw r}}getHeaders(){return{"Content-Type":"application/json",Authorization:`Bearer ${this.apiKey}`}}};function rr(e,t){if(!e||!e.obj)throw new Error("Received malformed packet: packet.obj is missing");const n=e.obj;if("reserved_assistant_message_id"in n&&"user_message_id"in n)return{message:t,messageIds:{userMessageId:n.user_message_id,assistantMessageId:n.reserved_assistant_message_id}};if(!("type"in n))throw new Error("Packet missing type field");switch(n.type){case"message_start":return{message:{id:`msg-${Date.now()}`,role:"assistant",content:"",timestamp:Date.now(),isStreaming:!0},status:""};case"message_delta":return t&&"assistant"===t.role?{message:{...t,content:t.content+(n.content||"")}}:{message:t};case"citation_info":return{message:t,citation:{citation_number:n.citation_number,document_id:n.document_id}};case"search_tool_start":return{message:t,status:n.is_internet_search?"Searching the web...":"Searching internally..."};case"search_tool_queries_delta":return{message:t,status:"Generating search queries..."};case"search_tool_documents_delta":return{message:t,documents:n.documents,status:"Reading documents..."};case"open_url_start":return{message:t,status:"Opening URLs..."};case"open_url_urls":return{message:t,status:"Fetching web pages..."};case"open_url_documents":return{message:t,documents:n.documents,status:"Processing web content..."};case"image_generation_start":case"image_generation_heartbeat":return{message:t,status:"Generating image..."};case"python_tool_start":case"python_tool_delta":return{message:t,status:"Running Python code..."};case"custom_tool_start":return{message:t,status:"Running custom tool..."};case"reasoning_start":case"reasoning_delta":return{message:t,status:"Thinking..."};case"deep_research_plan_start":return{message:t,status:"Planning research..."};case"research_agent_start":return{message:t,status:"Researching..."};case"intermediate_report_start":return{message:t,status:"Generating report..."};case"stop":case"overall_stop":return t?{message:{...t,isStreaming:!1}}:{message:t};case"error":throw new Error(`Stream error: ${n.exception}`);default:return{message:t}}}var ir="onyx-widget-session";function sr(e,t){try{const n={sessionId:e,messages:t,timestamp:Date.now()};sessionStorage.setItem(ir,JSON.stringify(n))}catch(fe){}}function ar(){try{sessionStorage.removeItem(ir)}catch(fe){}}var or;function lr(e,t,n,r){var i,s=arguments.length,a=s<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var o=e.length-1;o>=0;o--)(i=e[o])&&(a=(s<3?i(a):s>3?i(t,n,a):i(t,n))||a);return s>3&&a&&Object.defineProperty(t,n,a),a}var cr=class extends le{static{or=this}static{this.styles=[er,tr]}constructor(){super(),this.isOpen=!1,this.messages=[],this.isLoading=!1,this.isStreaming=!1,this.streamingStatus="",this.inputValue="",this.showEmptyPlaceholder=!1,this.showEmptyHiding=!1,this.documentMap=/* @__PURE__ */new Map,this.citationMap=/* @__PURE__ */new Map,this.lucideSvgCache=/* @__PURE__ */new Map,this.isDragging=!1,this.dragHasMoved=!1,this.dragPointerId=null,this.dragStartRect=null,this.dragGrabOffsetY=0,this.boundOnPointerMove=e=>this.onPointerMove(e),this.boundOnPointerUp=e=>this.onPointerUp(e),this.launcherEl=null,this.DRAG_Y_RANGE_PX=120,Lt.setOptions({breaks:!0,gfm:!0})}updated(e){super.updated(e),(e.has("messages")||e.has("isStreaming"))&&this.scrollToBottom(),this.loadLucideIcons(),this.launcherEl||(this.launcherEl=this.shadowRoot?.querySelector(".launcher"))}async fetchLucideSvg(e){if(this.lucideSvgCache.has(e))return this.lucideSvgCache.get(e);const t=`https://cdn.jsdelivr.net/gh/lucide-icons/lucide@latest/icons/${e}.svg`;try{const n=await fetch(t);if(!n.ok)return null;let r=await n.text();return r=r.replace(/<\?xml.*?\?>\s*/i,""),r=r.replace(/width=\"[^"]*\"/i,'width="1em"'),r=r.replace(/height=\"[^"]*\"/i,'height="1em"'),r=r.replace(/stroke=\"none\"/gi,""),this.lucideSvgCache.set(e,r),r}catch(fe){return null}}async loadLucideIcons(){if(!this.shadowRoot)return;const e=Array.from(this.shadowRoot.querySelectorAll(".lucide-icon[data-icon]"));await Promise.all(e.map(async e=>{const t=e.getAttribute("data-icon");if(!t)return;if("1"===e.dataset.loaded)return;const n=await this.fetchLucideSvg(t);if(n){e.innerHTML=n;const t=e.querySelector("svg");t&&(t.setAttribute("width","1em"),t.setAttribute("height","1em"),t.style.verticalAlign="middle",t.setAttribute("stroke","currentColor"),t.setAttribute("fill","none")),e.dataset.loaded="1"}}))}scrollToBottom(){requestAnimationFrame(()=>{const e=this.shadowRoot?.querySelector(".messages");e&&(e.scrollTop=e.scrollHeight)})}connectedCallback(){super.connectedCallback();try{const e="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined";if(!document.querySelector(`link[href="${e}"]`)){const t=document.createElement("link");t.rel="stylesheet",t.href=e,document.head.appendChild(t)}}catch(fe){}try{this.config=$n({backendUrl:this.backendUrl,apiKey:this.apiKey,agentId:this.agentId,primaryColor:this.primaryColor,backgroundColor:this.backgroundColor,textColor:this.textColor,agentName:this.agentName,logo:this.logo,mode:this.mode,launcherBottom:this.launcherBottom,launcherRight:this.launcherRight,launcherDraggable:this.launcherDraggable,includeCitations:this.includeCitations})}catch(t){this.error=t?.message||"Invalid widget configuration",this.config=$n({backendUrl:this.backendUrl||"",apiKey:this.apiKey||"",agentId:this.agentId,primaryColor:this.primaryColor,backgroundColor:this.backgroundColor,textColor:this.textColor,agentName:this.agentName,logo:this.logo,mode:this.mode||"launcher",launcherBottom:this.launcherBottom,launcherRight:this.launcherRight,launcherDraggable:this.launcherDraggable,includeCitations:this.includeCitations})}this.applyCustomColors(),this.applyLauncherPosition(),this.apiService=new nr(this.config.backendUrl,this.config.apiKey);const e=function(){try{const e=sessionStorage.getItem(ir);if(!e)return null;const t=JSON.parse(e);return Date.now()-t.timestamp>864e5?(ar(),null):t}catch(fe){return null}}();e&&(this.chatSessionId=e.sessionId,this.messages=e.messages),this.showEmptyPlaceholder=0===this.messages.length,"inline"===this.config.mode&&(this.isOpen=!0)}applyCustomColors(){this.config.primaryColor&&(this.style.setProperty("--theme-primary-05",this.config.primaryColor),this.style.setProperty("--theme-primary-06",this.adjustBrightness(this.config.primaryColor,-10))),this.config.backgroundColor&&(this.style.setProperty("--background-neutral-00",this.config.backgroundColor),this.style.setProperty("--background-neutral-03",this.adjustBrightness(this.config.backgroundColor,-10))),this.config.textColor&&this.style.setProperty("--text-04",this.config.textColor)}applyLauncherPosition(){this.config.launcherBottom&&this.style.setProperty("--onyx-launcher-bottom",this.config.launcherBottom),this.config.launcherRight&&this.style.setProperty("--onyx-launcher-right",this.config.launcherRight)}adjustBrightness(e,t){const n=parseInt(e.replace("#",""),16),r=Math.round(2.55*t),i=(n>>16)+r,s=(n>>8&255)+r,a=(255&n)+r;return"#"+(16777216+65536*(i<255?i<1?0:i:255)+256*(s<255?s<1?0:s:255)+(a<255?a<1?0:a:255)).toString(16).slice(1)}resetConversation(){this.abortController&&(this.abortController.abort(),this.abortController=void 0),this.messages=[],this.chatSessionId=void 0,this.error=void 0,this.inputValue="",this.isStreaming=!1,this.isLoading=!1,this.streamingStatus="",this.documentMap.clear(),this.citationMap.clear(),ar(),this.showEmptyPlaceholder=!0}renderMarkdown(e,t){try{let n=e;if(this.config.includeCitations)if(t?.length){const e=/* @__PURE__ */new Map;t.forEach((t,n)=>e.set(t.citation_number,n+1)),n=n.replace(/\[\[(\d+)\]\]\([^)]*\)/g,(t,n)=>{const r=e.get(Number(n));return r?`<sup>[${r}]</sup>`:""})}else n=n.replace(/\[\[(\d+)\]\]\([^)]*\)/g,"");const r=Lt.parse(n,{async:!1});return be(Qn.sanitize(r,{ADD_TAGS:["sup"]}))}catch(n){return e}}static{this.CITATIONS_COLLAPSED_COUNT=1}renderCitationBadge(e,t){const n=e.semantic_identifier||"Source",r=e.link&&/^https?:\/\//i.test(e.link)?e.link:void 0;return r?Z`<a
    ...
    `}};lr([ue({attribute:"backend-url"})],cr.prototype,"backendUrl",void 0),lr([ue({attribute:"api-key"})],cr.prototype,"apiKey",void 0),lr([ue({attribute:"agent-id",type:Number})],cr.prototype,"agentId",void 0),lr([ue({attribute:"primary-color"})],cr.prototype,"primaryColor",void 0),lr([ue({attribute:"background-color"})],cr.prototype,"backgroundColor",void 0),lr([ue({attribute:"text-color"})],cr.prototype,"textColor",void 0),lr([ue({attribute:"agent-name"})],cr.prototype,"agentName",void 0),lr([ue({attribute:"logo"})],cr.prototype,"logo",void 0),lr([ue()],cr.prototype,"mode",void 0),lr([ue({attribute:"launcher-bottom"})],cr.prototype,"launcherBottom",void 0),lr([ue({attribute:"launcher-right"})],cr.prototype,"launcherRight",void 0),lr([ue({attribute:"launcher-draggable",type:Boolean})],cr.prototype,"launcherDraggable",void 0),lr([ue({attribute:"include-citations",type:Boolean})],cr.prototype,"includeCitations",void 0),lr([de()],cr.prototype,"isOpen",void 0),lr([de()],cr.prototype,"chatSessionId",void 0),lr([de()],cr.prototype,"messages",void 0),lr([de()],cr.prototype,"isLoading",void 0),lr([de()],cr.prototype,"isStreaming",void 0),lr([de()],cr.prototype,"streamingStatus",void 0),lr([de()],cr.prototype,"error",void 0),lr([de()],cr.prototype,"inputValue",void 0),lr([de()],cr.prototype,"showEmptyPlaceholder",void 0),lr([de()],cr.prototype,"showEmptyHiding",void 0),cr=or=lr([(e=>(t,n)=>{void 0!==n?n.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)})("onyx-chat-widget")],cr),"undefined"==typeof customElements||customElements.get("onyx-chat-widget")||customElements.define("onyx-chat-widget",cr);export{cr as OnyxChatWidget};